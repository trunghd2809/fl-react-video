    ...
    createClass(VolumeMenuButton, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(VolumeBar, _extends({ onFocus: this.handleFocus,
                    onBlur: this.handleBlur
                }, this.props))
            );
        }
...
var propTypes$6 = {
  ...
  return React.createElement('div', { 'data-current-time': formatTime(currentTime, duration),
...
var ControlBar = function ControlBar(props) {
  ...
  var children = [React.createElement(PlayToggle, _extends({ key: 'toggle-play' }, props)), React.createElement(VolumeMenuButton, _extends({ key: 'volume-menu-button' }, props)), React.createElement(CurrentTimeDisplay, { key: 'current-time-display', player: props.player }), React.createElement(ProgressControl, _extends({ key: 'progress-control' }, props)), React.createElement(DurationDisplay, { key: 'duration-display', player: props.player }), React.createElement(SettingToggle, _extends({ key: 'setting-popup-toggle' }, props)), React.createElement(FullscreenToggle, _extends({ key: 'full-screen-toggle' }, props))];
  return React.createElement(
    'div',
...
var Player = function (_Component) {
    ...
    createClass(Player, [{
        ...
        value: function getChildren(props) {
            ...
            };var video = props.HLS ? React.createElement(
                Video,
                _extends({
                    ref: function ref(c) {
                        _this2.video = c;
            ...
            return [video, React.createElement(ControlBar, _extends({ key: 'control-bar'
            }, nps, { toggleSetting: props.toggleSetting, rootElement: this.manager.rootElement })), React.createElement(Shortcut, _extends({ key: 'short-cut'
            }, nps)), React.createElement(LoadingSpinner, { key: 'loading-spinner', player: props.player }), React.createElement(Bezel, { key: 'bezel', manager: props.manager })];
        }
    }, {
        key: 'getState',
        value: function getState() {
...
export { Player, Video, PlayToggle as TogglePlay, CurrentTimeDisplay as CurrentTime, ChangeSubVi };
//# sourceMappingURL=ekiio-video-react.es.js.map
