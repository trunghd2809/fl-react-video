...
libConfig.targets = [
  { dest: 'dist/ekiio-video-react.cjs.js', format: 'cjs' },
  { dest: 'dist/ekiio-video-react.es.js', format: 'es' },
];
...
umdFullConfig.targets = [
  { dest: 'dist/ekiio-video-react.full.js', format: 'umd' },
];
...
umdFullConfigMin.targets = [
  { dest: 'dist/ekiio-video-react.full.min.js', format: 'umd' },
];
...
umdConfig.targets = [
  { dest: 'dist/ekiio-video-react.js', format: 'umd' },
];
...
umdConfigMin.targets = [
  { dest: 'dist/ekiio-video-react.min.js', format: 'umd' },
];
